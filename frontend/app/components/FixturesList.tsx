  ...
  return <>
    <section className="contest-card fixtures-section" aria-labelledby="upcoming-title">
      ...
      {upcoming !== null && upcoming.length > 0 && <div className="fixture-list">
        {upcoming.map((fixture) => <div className="fixture-row" key={fixture.fixtureId}>
          <div><strong>{fixture.homeTeamName || "Team pending"} vs {fixture.awayTeamName || "Team pending"}</strong><small>{fixture.competition || "Competition pending"} · {new Date(fixture.kickoffAt).toLocaleString()}</small></div>
    ...
    <section className="contest-card fixtures-section" aria-labelledby="replay-list-title">
      ...
      {replays !== null && replays.length > 0 && <div className="fixture-list">
        {replays.map((fixture) => <Link href={`/replay/${fixture.fixtureId}`} className="fixture-row fixture-row-link" key={fixture.fixtureId}>
          <div><strong>{fixture.teams}</strong><small>{fixture.goals} verified goal{fixture.goals === 1 ? "" : "s"}</small></div>
