...
- Captured `goal.Data.PlayerId`, `injury.Data.PlayerId`, `substitution.Data.PlayerInId`, and `substitution.Data.PlayerOutId` resolve to `lineups[].player.normativeId`; they do **not** resolve to `fixturePlayerId`.
